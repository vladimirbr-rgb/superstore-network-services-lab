...
| Часть | Содержание | Количество заданий | Количество скриншотов |
|---|---|---:|---:|
| Часть 1 | VLAN, маршрутизация, DHCP, NAT, DNAT и межофисная связность | 13 | 52 |
| Часть 2 | DNS, NTP, Ansible, Postfix, FTP, Nginx и синхронизация времени | 6 | 53 |
| Часть 3 | Развёртывание Active Directory и проверка GPO | 1 | 15 |
| Всего | Результаты выполнения всех заданий | 20 | 120 |
